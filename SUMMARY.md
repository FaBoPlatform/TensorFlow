...
* Numpy
    ...
    * [スライシング](numpy/numpy008.ipynb)
    * [ブールインデックス](numpy/numpy009.ipynb)
    * [転置行列](numpy/numpy010.md)
    * [Numpyオブジェクトの保存](numpy/numpy011.md)
    * [CSVファイルの読み込み・保存](numpy/numpy012.md)
    * [Numpyオブジェクトの型・次元数・サイズ](numpy/numpy013.ipynb)
    * [平均・標準偏差](numpy/numpy014.ipynb)
    * [ユニバーサル関数](numpy/numpy015.ipynb)
    * [ソート](numpy/numpy_sort.ipynb)
    * [集合関数](numpy/numpy_set_func.ipynb)
    * [行列関数](numpy/numpy_matrix_func.ipynb)
    * [さまざまな乱数](numpy/numpy_random.ipynb)
    * [結合関数](numpy/numpy_concat.ipynb)
    * [平坦化](numpy/numpy_flatten.md)
    * [配列の繰り返し](numpy/numpy_repeat.ipynb)
