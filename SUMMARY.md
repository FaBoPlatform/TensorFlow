...
* Numpy
    ...
    * [行列の演算](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy006.md)
    * [乱数のシード](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy007.md)
    * [スライシング](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy008.md)
    * [ブールインデックス](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy009.md)
    * [転置行列](numpy/numpy010.md)
    * [Numpyオブジェクトの保存](numpy/numpy011.md)
    * [CSVファイルの読み込み・保存](numpy/numpy012.md)
    * [Numpyオブジェクトの型・次元数・サイズ](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy013.md)
    * [平均・標準偏差](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy014.md)
    * [ユニバーサル関数](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy015.md)
    * [ソート](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_sort.md)
    * [集合関数](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_set_func.md)
    * [行列関数](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_matrix_func.md)
    * [さまざまな乱数](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_random.md)
    * [結合関数](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_concat.md)
    * [平坦化](numpy/numpy_flatten.md)
    * [配列の繰り返し](https://github.com/FaBoPlatform/TensorFlow/numpy/numpy_repeat.md)
