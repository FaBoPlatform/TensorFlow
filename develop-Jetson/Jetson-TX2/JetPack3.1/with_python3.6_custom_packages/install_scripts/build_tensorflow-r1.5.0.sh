...
mkdir -p /compile \
&& cd /compile \
&& git clone -b r1.5 https://github.com/tensorflow/tensorflow
...
mv -f /tmp/tensorflow_pkg/tensorflow-1.5.0-cp36-cp36m-linux_aarch64.whl $SCRIPT_DIR/../binary
