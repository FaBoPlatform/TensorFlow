...
# Python3.6 レポジトリ追加
########################################
{ echo;cat /dev/stdin; } | add-apt-repository -y ppa:jonathonf/python-3.6
apt-get update
...
{ echo; cat /dev/stdin; } | update-alternatives --install /usr/bin/python3 python /usr/bin/python3.6 0
